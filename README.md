...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/still-dawn-f480)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/still-dawn-f480
```

A live public deployment of this template is available at [https://still-dawn-f480.templates.workers.dev](https://still-dawn-f480.templates.workers.dev)
